<template>
  <div class="dashboard-wrapper">
    <div class="admin_sidebar">
      <div class="logo">
        <img src="../assets/sqlogo.svg" alt="logo" width="50" height="50" />
        <h5 class="logo-text">Whiz.it</h5>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      stats: [
        { title: 'Subjects', value: '', icon: 'fas fa-book' },
        { title: 'Chapters', value: '', icon: 'fas fa-bookmark' },
        { title: 'Quizzes', value: '', icon: 'fas fa-question-circle' },
        { title: 'Questions', value: '', icon: 'fas fa-tasks' },
        { title: 'Users', value: '', icon: 'fas fa-users' }
      ]
    };
  },
  methods: {
