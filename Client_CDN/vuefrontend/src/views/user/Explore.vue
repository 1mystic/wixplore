             ...
             <!-- Featured Quizzes -->
              ...
              >
                <div class="slider-navigation">
                  <button class="slider-nav slider-prev" id="sliderPrev" @click="scrollCarouselLeft">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>
                  </button>
                  <button class="slider-nav slider-next" id="sliderNext" @click="scrollCarouselRight">
                  ...
                  <div v-for="quiz in displayedQuizzes" :key="quiz.id" class="quiz-card-wrapper">
                    <div class="quiz-card" :class="{ 'selected': selectedSubject === quiz.subject_id }">
                      <div class="quiz-card-image">
                        <div class="bookmark-icon" :class="{ 'bookmarked': quiz.bookmarked }" @click="toggleBookmark(quiz.id)">
...
async created() {
  ...
  // Check for subject filter in query
  this.applySubjectFilterFromRoute();
},
watch: {
  '$route.query.subject': function(newSubject) {
    this.applySubjectFilterFromRoute();
  }
},
  methods: {
  ...
  formatDuration(duration) {
    ...
    applySubjectFilterFromRoute() {
      const subjectName = this.$route.query.subject;
      if (subjectName && this.subjects.length) {
    ...
    scrollCarouselLeft() {
      ...
      if (track) {
        const card = track.querySelector('.quiz-card-wrapper');
...
.search_bar {
    ...
    align-items: center;
    background-color: #ffffff;
    border: 1px solid rgb(250, 193, 193);
